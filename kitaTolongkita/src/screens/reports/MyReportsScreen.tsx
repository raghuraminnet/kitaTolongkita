...
const styles = StyleSheet.create({
  ...
  emptyTitle: { ...typography['title-lg'], color: colors['on-surface'], fontWeight: '700', marginBottom: spacing.sm },
  ...
  statusText: { ...typography['label-xs'], fontWeight: '700' },
  ...
  reasonChipText: { ...typography['label-xs'], color: colors['on-surface-variant'] },
  moreReasonsText: { ...typography['label-xs'], color: colors['on-surface-variant'], alignSelf: 'center' },
  reportCardFooter: { flexDirection: 'row', justifyContent: 'space-between' },
  reportDate: { ...typography['label-xs'], color: colors['on-surface-variant'] },
  resolvedDate: { ...typography['label-xs'], color: '#4CAF50' },
});
